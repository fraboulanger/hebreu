...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--root", help="root of file tree", default="../htmlR")
    parser.add_argument("-nf", "--nouvHTML", help="nouvelle racine des fichiers", default="../html")
    parser.add_argument("-p", "--prog", help="emplacement des fichiers prog", default="/prog")
    parser.add_argument("-xn", "--exclude_name", nargs='*', help="exclude name", default=["\.bak$","\.png$","^Code","\.pdf","\.gif$","\.py$"])
...
#
    ...
    for el in os.listdir(args.root):
         os.replace("/".join([args.root,el]),"/".join([args.nouvHTML,el]))
    os.rmdir(args.root)
